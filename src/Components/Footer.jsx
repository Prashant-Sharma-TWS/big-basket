        ...
        <div className={styles.footer}>
            <div className={styles.footerSection1}>
                <div>
                    <ul>
                        ...
                        <li><Link to={"#"}>Green bigbasket</Link></li>
                        <li><Link to={"#"}>Privacy Policy</Link></li>
                        <li><Link to={"#"}>Affiliate</Link></li>
                        <li><Link to={"#"}>Terms and Conditions</Link></li>
                        <li><Link to={"#"}>Careers At bigbasket</Link></li>
                        <li><Link to={"#"}>bb Instant</Link></li>
                        <li><Link to={"#"}>bb Daily</Link></li>
                        <li><Link to={"#"}>bb Blog</Link></li>
                        <li><Link to={"#"}>bbnow</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    <ul>
                        ...
                        <li><Link to={"#"}>bb Wallet FAQs</Link></li>
                        <li><Link to={"#"}>bb Wallet T&Cs</Link></li>
                        <li><Link to={"#"}>Vendor Connect</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="https://twitter.com/Bigbasket_com" target={"_blank"}><img className={styles.socialbadge} src={twitter} alt="" /></a>
                            <a href="https://www.instagram.com/bigbasketcom/" target={"_blank"}><img className={styles.socialbadge} src={instagram} alt="" /></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div className={styles.footerSection2}>
                ...
                <div>
                    ...
                    <div>
                        <span> Amul Nescafe MTR Red Bull, elite cake Pediasure Yummiez Yera Yakult Britannia Wow Momo Fortune Haldirams Ferrero Lays Patanjali McCain kwality walls Cadbury Dairy Milk Pedigree</span>
                    </div>
                </div>
                <div>
                    <div>
                ...
                <div>
                    ...
                    <div className={styles.paymentIconDiv}>
                        <div>
                            <img className={styles.paymentVisa} src={visa} />
                            <img className={styles.paymentMaster} src={mastercard} alt="" />
                            <img className={styles.paymentPaytm} src={paytm} alt="" />
                            <img className={styles.paymentMobi} src={mobikwik} alt="" />
                            <img className={styles.paymentRupay} src={rupay} alt="" />
                            <img className={styles.paymentAmerican} src={american} />
                        </div>
                    </div>
                </div>
            </div>

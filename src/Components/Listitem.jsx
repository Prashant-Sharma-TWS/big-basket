  ...
  return (
    <div className={styles.listItemDiv}>
        ...
        <div>
            ...
            <div className={styles.fade}><strike>Rs: {item.product.mrp}</strike></div>
        </div>
        <div>
            <div className={styles.quantitydiv}>
                <button onClick={handleDecrease}>-</button>
                <input type={"number"} id={item.id} value={item.quantity}  min={"1"} onChange={(e)=> setValue(e.target.value)}/>

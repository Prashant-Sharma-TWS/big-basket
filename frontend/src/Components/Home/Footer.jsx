        ...
        <div>
          ...
          <ul>
            <li>
              ...
              >
                <img className={styles.socialbadge} src={facebook} alt="" />
              </a>
              <a
                target="_blank"
                rel="noreferrer"
              ...
              >
                <img className={styles.socialbadge} src={pinterest} alt="" />
              </a>
              <a
                target="_blank"
                rel="noreferrer"
              ...
              >
                <img className={styles.socialbadge} src={twitter} alt="" />
              </a>
              <a
                target="_blank"
                rel="noreferrer"
              ...
              >
                <img className={styles.socialbadge} src={instagram} alt="" />
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className={styles.footerSection2}>
        ...
        <div>
          ...
          <div className={styles.paymentIconDiv}>
            <div>
              <img className={styles.paymentVisa} src={visa} alt="" />
              ...
              <img className={styles.paymentAmerican} src={american} alt="" />
            </div>
          </div>
        </div>
      </div>
